...
/*
    -What is a dropdown?
    --Dropdown is a WebElement which has list of options.

    -How do you handle dropdown? What do you do to automate dropdown?
    --Dropdowns are created by using Select class.So we first locate the dropdown element, then use select class
